...
class User:
    def __init__(self, username, punteggio):
        ...
        self.punteggio = int(punteggio)  # Converti il punteggio in intero

    def __str__(self):
        return f"{self.username} {self.punteggio}"
...
def game(list):
    ...
    # Sovrascrivo il file originale con i punteggi ordinati
